...
import type { Notification, NotificationCounts, NotificationPreferences, NotificationAnalytics } from '@/types/notification.types';
...
interface NotificationContextType {
    ...
    // Actions
    fetchNotifications: (page?: number, limit?: number, type?: string, category?: string, read?: boolean) => Promise<any>;
    ...
    deleteNotificationById: (id: string) => Promise<{ success: boolean; error?: any }>;
    clearAllNotificationsForUser: () => Promise<{ success: boolean; error?: any }>;
    updateUserNotificationPreferences: (updates: Partial<NotificationPreferences>) => Promise<{ success: boolean; data?: any; error?: any }>;
    refresh: () => void;
    forceRefresh: () => void;
    startPolling: () => void;
    stopPolling: () => void;
...
export function NotificationProvider({
    ...
    return (
        <NotificationContext.Provider value={{
            ...
            updateUserNotificationPreferences: context.updateUserNotificationPreferences,
...
export function useNotificationBell() {
    ...
    if (!context) {
        throw new Error('useNotificationBell must be used within a NotificationProvider');
    }
