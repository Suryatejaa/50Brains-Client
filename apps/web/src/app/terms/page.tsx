              ...
              <div className="prose prose-lg max-w-none">
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 text-gray-700">
                    By accessing and using 50BraIns ("we," "our," or "us"), you
                  ...
                  <p className="text-gray-700">
                    ...
                    website located at 50brains.com (the "Service") operated by
                    50BraIns.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 text-gray-700">
                    50BraIns is a digital platform that connects brands with
                    talented creators, influencers, and freelancers. Our Service
                    provides:
                  </p>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 text-gray-700">
                    50BraIns operates on a credit-based system. All payments
                    must be made in advance through our secure payment gateway.
                  </p>
                  <div className="mb-4 rounded-none border border-blue-200 bg-blue-50 p-4">
                    ...
                    <ul className="list-inside list-disc space-y-1 text-blue-700">
                      ...
                      <li>
                        Unused credits do not expire but may be subject to
                        service fees
                      </li>
                ...
                <section className="mb-8">
                  ...
                  <div className="rounded-none border border-gray-200 bg-gray-50 p-4">
                    <div className="space-y-2 text-sm text-gray-700">
                      <div>
                        <strong>Email:</strong> legal@50brains.com
                      </div>
                      <div>
                        <strong>Support:</strong> support@50brains.com
                      </div>
                      <div>
